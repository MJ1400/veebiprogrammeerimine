...
?>
  ...
  <div id="changeAlttext" class="modalcaption">
    ...
    <label><input type="radio" name="privacy" value="1"> Avalikud pildid <label><br>
    <label> <input type="radio" name="privacy" value="2"> Kasutajate pildid <label> <br>
    <input type="radio" name="privacy" value="3"> Privaatsed pildid <br>
    <input type="button" value="Salvesta kirjeldus ja privaatsus" id="saveAlttext">
  </div>
