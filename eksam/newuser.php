<?php
  ...
  if(isset($_POST["submitUserData"])) {
    ...
    // kontrollime, kas kuupäev on valiidne - in olemas
  ...
  if(empty($nameError) and empty($surnameError) and empty($birthMonthError) and empty($birthYearError) and empty ($birthDayError) and empty($birthDateError)
  and empty($genderError) and empty($emailError) and empty($passwordError) and empty($confirmpasswordError)) {
...
<!-- https://www.w3schools.com/php/php_form_validation.asp turvalisus -->
